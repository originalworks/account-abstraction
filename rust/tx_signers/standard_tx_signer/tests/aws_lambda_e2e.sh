...
export STANDARD_SENDER_QUEUE_URL="http://localhost:4566/000000000000/transaction-sender-queue"
export BLOB_SENDER_QUEUE_URL="http://localhost:4566/000000000000/transaction-sender-queue"
