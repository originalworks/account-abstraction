...
export SENDER_STANDARD_QUEUE_URL="http://localhost:4566/000000000000/transaction-sender-queue"
export SENDER_BLOB_QUEUE_URL="http://localhost:4566/000000000000/transaction-sender-queue"
